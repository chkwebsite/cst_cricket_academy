                    ...
                    <div className="bg-white rounded-4 shadow-sm p-4 mb-4">
                        <div className="d-flex flex-column flex-md-row justify-content-between align-items-start align-items-md-center gap-3">
                            ...
                            {hasPermission("profiles.create") &&
                                <Link href="/next_panel/profiles/new" className="btn btn-primary fw-semibold">
                                            ...
                                            <tr key={profile.id}>
                                                ...
                                                <td className="text-end">
                                                    <div className="btn-group btn-group-sm" role="group">
                                                        <Link href={`/next_panel/profiles/${profile.id}`} className="btn btn-outline-primary" aria-label="View profile">
                                                            <ArrowUpRight size={16} />
                                                        </Link>

                                                        {hasPermission("profiles.edit") && <Link href={`/next_panel/profiles/${profile.id}/edit`} className="btn btn-outline-secondary" aria-label="Edit profile">
                                                            <Edit size={16} />
                                                        </Link>}
